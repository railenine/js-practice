...
/* harmony import */ var _modules_downloadingContent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/downloadingContent */ "./src/js/modules/downloadingContent.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var moduleSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    next: '.nextmodule',
    prev: '.prevmodule'
  ...
  new _modules_downloadingContent__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init();
});
...
/***/ "./src/js/modules/downloadingContent.js":
/*!**********************************************!*\
  !*** ./src/js/modules/downloadingContent.js ***!
  \**********************************************/
/*! exports provided: default */
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function initMask() {
      var setCurcirPosition = function setCurcirPosition(pos, elem) {
        elem.focus();
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          _this2.slides[_this2.slideIndex - 1].classList.add('fadeInUp');
        });
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    key: "autoplayStoppedStarted",
    value: function autoplayStoppedStarted() {
      var _this3 = this;
    ...
    value: function bindTriggers() {
      ...
      this.prev.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (_this4.slides[_this4.slides.length - 1].tagName == 'BUTTON') {
            active = _this4.slides[_this4.slides.length - 3];
          } else {
            active = _this4.slides[_this4.slides.length - 1];
          }

          _this4.container.insertBefore(active, _this4.slides[0]);
